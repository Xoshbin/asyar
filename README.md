...
_Benchmark table pending — generated by [`benchmarks/bench.sh`](benchmarks/README.md)._

<!-- benchmarks:end -->

Don't take our word for it: [`benchmarks/bench.sh`](benchmarks/README.md) measures both apps black-box on your own machine — hotkey-to-window latency, cold start, full-process-group memory, idle CPU, and disk size — and regenerates this table with `--update-readme`.
