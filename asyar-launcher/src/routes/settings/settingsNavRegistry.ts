...
export const SETTINGS_SEARCH_INDEX: SettingsSearchEntry[] = [
  ...
  },
  {
    ...
    description: 'Review how local private data is encrypted on disk.',
    tab: 'privacy',
    tabLabel: 'Privacy',
    sectionAnchor: 'privacy-encryption',
    keywords: ['keychain', 'ciphertext', 'local data'],
  },
  {
    id: 'privacy-crash-reports',
    title: 'Crash and error reports',
    description: 'Choose whether crash reports are never sent, previewed, or sent automatically.',
    tab: 'privacy',
    tabLabel: 'Privacy',
    sectionAnchor: 'privacy-reports',
    keywords: ['errors', 'reports', 'telemetry'],
  },
  {
    id: 'privacy-usage-share',
    title: 'Anonymous usage share',
    description: 'Control anonymous daily usage counts and reset the anonymous id.',
    tab: 'privacy',
    tabLabel: 'Privacy',
    sectionAnchor: 'privacy-usage',
    keywords: ['analytics', 'anonymous id', 'telemetry'],
  },
  {
    id: 'privacy-clipboard',
    title: 'Clipboard privacy',
    description: 'Review clipboard exclusions and denylist entries.',
    tab: 'privacy',
    tabLabel: 'Privacy',
    sectionAnchor: 'privacy-clipboard',
    keywords: ['denylist', 'password manager', 'clipboard history'],
  },
  {
    id: 'privacy-secret-redaction',
    title: 'Secret redaction',
    description: 'Redact API keys, JWTs, private keys, and other secrets before storage.',
    tab: 'privacy',
    tabLabel: 'Privacy',
    sectionAnchor: 'privacy-redaction',
    keywords: ['api key', 'jwt', 'private key', 'secrets'],
  },
  {
    id: 'privacy-shell-trust',
    title: 'Terminal trust store',
    description: 'Review and revoke trusted programs for extensions that spawn shell commands.',
    tab: 'privacy',
    tabLabel: 'Privacy',
    sectionAnchor: 'privacy-shell-trust',
    keywords: ['terminal', 'shell', 'trusted programs', 'revoke'],
  },
  {
    id: 'developer-tools',
    title: 'Developer tools',
    description: 'Enable the inspector, verbose logging, IPC/RPC tracing, and sideloading.',
    tab: 'developer',
    tabLabel: 'Developer',
    sectionAnchor: 'developer-tools',
    keywords: ['inspector', 'logging', 'tracing', 'sideload'],
  },
  {
    id: 'developer-extensions',
    title: 'Dev extensions',
    description: 'Reload and inspect locally attached development extensions.',
    tab: 'developer',
    tabLabel: 'Developer',
    sectionAnchor: 'developer-extensions',
    keywords: ['hot reload', 'attached', 'local extension'],
  },
  {
    id: 'about-release-channel',
    title: 'Release channel',
    description: 'Choose stable releases or beta pre-release updates.',
    tab: 'about',
    tabLabel: 'About',
    sectionAnchor: 'about-updates',
    keywords: ['stable', 'beta', 'channel'],
  },
  {
    id: 'about-updates',
    title: 'Check for updates',
    description: 'Check for available Asyar updates and restart when an update is ready.',
    tab: 'about',
    tabLabel: 'About',
    sectionAnchor: 'about-updates',
    keywords: ['version', 'restart', 'update'],
  },
  {
    id: 'about-links',
    title: 'Project links',
    description: 'Open the Asyar GitHub repository, privacy policy, or license.',
    tab: 'about',
    tabLabel: 'About',
    sectionAnchor: 'about-links',
    keywords: ['github', 'privacy policy', 'license'],
  },
];
...
export const SECTION_ANCHORS: Record<string, SectionAnchor[]> = {
  ...
  privacy: [
    { id: 'privacy-encryption', label: 'Encryption' },
    { id: 'privacy-reports', label: 'Reports' },
    { id: 'privacy-usage', label: 'Usage' },
    { id: 'privacy-clipboard', label: 'Clipboard' },
    { id: 'privacy-redaction', label: 'Redaction' },
    { id: 'privacy-shell-trust', label: 'Shell trust' },
  ],
  advanced: [
  ...
  developer: [
    { id: 'developer-tools', label: 'Tools' },
    { id: 'developer-extensions', label: 'Dev extensions' },
  ],
  about: [
    { id: 'about-updates', label: 'Updates' },
    { id: 'about-credits', label: 'Credits' },
    { id: 'about-links', label: 'Links' },
  ],
};
