...
export const INJECTS_EXTENSION_ID = new Set<Namespace>([
  'storage', 'ai', 'oauth', 'shell', 'interop', 'cache', 'preferences', 'notifications', 'power', 'systemEvents', 'appEvents', 'timers', 'fsWatcher', 'state', 'searchBar', 'diagnostics', 'onboarding', 'runs',
